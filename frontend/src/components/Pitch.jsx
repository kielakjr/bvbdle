...
const Pitch = ({ children }) => {
  return (
    <div className="relative aspect-7/10 lg:w-7/10 md:w-12/10 w-16/10 border-4 border-white rounded-lg shadow-lg bg-linear-to-tl from-emerald-500 to-lime-600">
