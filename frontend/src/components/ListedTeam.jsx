...
const ListedTeam = ({ lineup, team }) => {
  ...
  return (
    <ul className="max-h-128 w-15/10 lg:w-4/10 md:w-12/10 overflow-y-auto p-4 rounded-lg shadow-md bg-linear-to-t from-yellow-200 via-yellow-300 to-yellow-400 mb-5 lg:mb-0">
