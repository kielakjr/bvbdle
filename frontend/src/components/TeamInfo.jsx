  ...
  return (
    <div className={isHome ? 'w-1/3 justify-start mx-17' : 'w-1/3 justify-end mx-17'}>
      <div className={`flex flex-col ${isHome ? "lg:flex-row" : "lg:flex-row-reverse"} items-center`}>
        ...
        {isScoreGuessed &&
        <ul className={`text-md italic mx-6 flex flex-col justify-center items-center ${isHome ? "lg:items-start lg:ml-8" : "lg:items-end lg:mr-8"} w-24/10 overflow-y-auto max-h-48`}>
