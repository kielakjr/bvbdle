...
const TeamSquadGuesser = () => {
  ...
  return (
    <div className="w-1/5 flex flex-col justify-center text-center items-center self-start">
      ...
      <PlayerSearch disabled={guesses >= MAX_GUESSES} className="border-b-2 text-white border-gray-400 focus:border-yellow-500 outline-none" onSelect={handlePlayerSelect}/>
